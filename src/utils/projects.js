export const projects = [
  ...
  },
  {
    ...
    description:
      "Open source introductory linear algebra textbook with interactive problems and solutions.",
    tech: ["XML", "PreText"],
  ...
  },
  {
    title: "String Art",
    description:
      "Straight lines make an envelope of a parbola animated using pure Javascript.",
    tech: ["Javascript"],
  ...
  },
  {
    ...
    description: "Last cut coasters of some famour aperiodic tilings.",
